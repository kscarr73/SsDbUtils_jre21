...
public class SsDbUtils {
    ...
    public static PreparedStatement returnStatement(Connection conn, String sql) throws ApiException {
        ...
        try {
            ...
            throw processException(sqx);
        }

        return ps;
    }

    public static PreparedStatement returnStatement(Connection conn, String sql, Object[] args) throws ApiException {
    ...
    public static void populateParameters(PreparedStatement ps, Object[] args) throws ApiException {
        try {
    ...
    public static Tuple<PreparedStatement, ResultSet> returnResultset(Connection conn, String sql, Object[] args) throws ApiException {
     ...
     */
    public static Integer queryForInt(Connection conn, String sql, Object[] args) throws ApiException {
        PreparedStatement ps = null;
     ...
     * @return the integer that was found
     */
    public static Integer queryForInt(PreparedStatement ps, Object[] args) throws ApiException {
        ResultSet rs = null;
    ...
    public static Long queryForLong(Connection conn, String sql, Object[] args) throws ApiException {
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public static BigDecimal queryForDecimal(Connection conn, String sql, Object[] args) throws ApiException {
        PreparedStatement ps = null;
        ResultSet rs = null;
     ...
     */
    public static Timestamp queryForTimestamp(Connection conn, String sql, Object[] args) throws ApiException {
        PreparedStatement ps = null;
        ResultSet rs = null;
     ...
     */
    public static Date queryForDate(Connection conn, String sql, Object[] args) throws ApiException {
        PreparedStatement ps = null;
        ResultSet rs = null;
     ...
     */
    public static String queryForString(Connection conn, String sql, Object[] args) throws ApiException {
        PreparedStatement ps = null;
        ResultSet rs = null;
     ...
     * @return the String that was found
     */
    public static String queryForString(PreparedStatement ps, Object[] args) throws ApiException {
        ResultSet rs = null;
    ...
    public static List<Object> queryForRow(Connection conn, String sql, Object[] args) throws ApiException {
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public static List<Object> queryForRow(PreparedStatement ps, Object[] args) throws ApiException {
        ResultSet rs = null;
    ...
    public static List<Map<String, Object>> queryForAllRows(Connection conn, String sql, Object[] args) throws ApiException {
     ...
     */
    public static Integer insertWithKey(Connection conn, String sql, Object[] args, String[] keys) throws ApiException {
    ...
    public static Long insertWithLongKey(Connection conn, String sql, Object[] args, String[] keys) throws ApiException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
    ...
    public static String insertWithStringKey(Connection conn, String sql, Object[] args, String[] keys) throws ApiException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
     ...
     * @return Returns the Key created with the insert
     */
    public static boolean update(Connection conn, String sql, Object[] args) throws ApiException {
        PreparedStatement stmt = null;
     ...
     *
     * @throws ApiException if there is any exception during the statement
     */
    public static int updateWithCount(Connection conn, String sql, Object[] args) throws ApiException {
        PreparedStatement stmt = null;
     ...
     * @throws ApiException
     */
    public static boolean update(PreparedStatement ps, Object[] args) throws ApiException {
        populateParameters(ps, args);
     ...
     * @throws ApiException
     */
    public static int query(Connection conn, String sql, Object[] args, RowMapper<?> map) throws ApiException {
        Tuple<PreparedStatement, ResultSet> rs = null;
     ...
     * @throws ApiException
     */
    public static int queryLimit(Connection conn, String sql, Object[] args, RowMapper<?> map, int iStart, int iCount) throws ApiException {
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public static List<String> getFieldNames(ResultSet rs) throws ApiException {
    ...
    private static void queryForAllRowsIntoApiObject(Connection conn, String sql, Object[] args, ApiObject subject) throws ApiException {
        Tuple<PreparedStatement, ResultSet> rs = null;
    ...
    public static ApiException processException(SQLException sqlEx) {
        if (sqlEx.getMessage() != null) {
            if (sqlEx.getMessage().contains("Duplicate")) {
                return new ApiException(409, "Duplicate Record");
            } else {
                return new ApiException(400, "SQL: " + sqlEx.getMessage());
            }
        } else {
            return new ApiException(500, "SQL Exception");
        }
    }
